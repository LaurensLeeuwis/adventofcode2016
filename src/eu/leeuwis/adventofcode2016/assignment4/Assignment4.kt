...
fun getEncryptedName(checksum: String, line: String, sector: Int): String {
    val encryptedName = line.substring(0, line.length - checksum.length - 2 - "${sector}".length)
    return encryptedName
}

fun getSector(checksum: String, line: String): Int {
...
fun getChecksum(line: String) = line.split("[")[1].split("]")[0]
